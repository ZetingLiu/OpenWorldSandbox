from ows.llm import GPTClient
from ows.synth.prompts import ENVIRONMENT_GENERATION_SYSTEM_PROMPT, ENVIRONMENT_GENERATION_USER_PROMPT
...
import sys
from ows.tools import tools_robust_json_loads, normalize_scenario_name, format_db_schema, tools_token_count, wait_port_free, wait_for_server, get_random_available_port, tools_jsonl_save, tools_jsonl_load
...
def test_run_specific_env(idx: int, env_config: dict) -> tuple[bool, str, dict]:
    ...
    try:
        ...
        server_process = subprocess.Popen(
            [
                sys.executable, '-m', 'ows.synth.server',
                '--port', str(port),
